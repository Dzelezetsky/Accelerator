...
import os
import yaml
from blt_sh_tools4mujoco import TD3, New_Trans_RB, env_constructor
import copy
#########################################################
...
def second_stage(policy, config, args, experiment):
    ...
    state = env.reset(seed=args.seed+100)
...
if __name__ == "__main__":
    ...
    parser.add_argument("--env", default="HalfCheetahBLT-V-v0")       
    ...
    parser.add_argument("--eval_freq", default=3e5, type=int)       #3e3
